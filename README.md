...
The Kitchen Assistant is an app to help an individual plan out their meal by sharing easy food recipes, while also maintaining a record of available items in the inventory. The app does not only help maintain that, it also helps the user to create a shopping list and add items to it according to the shortage of ingredients required for any particular recipe.
Using this app is very easy and convenient. A user can quickly and effortlessly view all recipes are available in the program and choose any according to their liking. They can also view the items in the inventory and can manually add more or change the amount of the available items.
...
## UX/UI <a name="ux"></a>
 ...
 ### User Demographic: <a name="demographic"></a>
  - The Kitchen-Assistant app targets people who wish to have an organised kitcken, with all their recipes and the required cooking ingredients saved at one platform. The App enables the user to easily access these recipes and be updated with the ingredient's availability.
 
 ### User Stories:<a name="stories"></a>
  - ### First Time User:
    1. As a first time user, I want to understand the functioning of the application without getting confused with any of its features.
    1. As a first time user, I want to easily navigate through the app without getting overwhelmed by any of the features.
    1. As a first time user, I want the instructions to be clear and precise.

  - ### Regular/Frequent User:
    1. As a regular user, I want to organise my kitchen easily without any hassle.
    1. As a regular user, I want to have the knowledge of where to go to achieve a particular task.
...
### Present Features <a name="present"></a>
  - The main menu displays the three basic services provided by the Kitchen-Assistant App:
    ...
    - Check Inventory
    - Check Shopping List
  - A user can select any of the services by typing the numbers "1" or "2" or "3" etc. which will take them to the specific service.
  ...
  - Check Recipe: <a name="recipe"></a>
    ...
    1. If the user says yes, (by typing “y”), the app then ask the user what they would like to cook, and the user can select any recipe of their choice by typing in the name of the recipe, (for eg. Creamy Pasta) from the available list.
    1. The app then checks the amount of the required ingredients and compares them against the ingredients' amount available in the inventory.
    1. If all ingredients are available in required amount, the app then displays the steps to cook the selected food recipe.
    1. In case all ingredients are not available, it gives a message saying “Not all ingredients available” followed by adding the items and their amount to the shopping list for the user's convenience.
    1. For demonstration purpose, couple of ingredients for Butter Chicken are not available and can be tested for the app’s response to it.
    1. If the user chooses “no” when asked to cook, or once the steps are displayed, the app then asks the user whether they would like to go back to the main menu.
  ...
  - Check Inventory: <a name="inventory"></a>
    ...
    1. The app then asks the user whether they would like to make any changes to it. The user can either opt to do so or not by pressing “y” or “n” respectively.
    1. If the user chooses to edit the inventory, the app will display the instruction on how to add/edit an item.
    1. Whenever the user enters an item and amount, the app checks the inventory of the item that is already there.
    ...
    1. Once done, the user can exit the edit mode by pressing “0”.
  ...
  - Check Shopping List: <a name="shopping-list"></a>
    1. When the user selects the “Check Shopping List” feature, the app checks the google sheet and displays all the items added to the shopping list tab.
    <br><br>
    ...
    1. The app then provides four options to the user:
        - Add Items: <a name="add"></a>
            1. The app allows the user to add new items to the shopping list.
            1. When selected, the app displays the instructions on how to add new items and prompts the user to add the item’s name and amount.
            1. Once added, the app then asks whether the user wants to continue.
            1. The user can exit this mode by either pressing “n” when asked whether to continue or by pressing “0” when prompted to add item’s name.
            <br><br>
            ![Image of the add items to shopping list menu](./assets/readme-images/shopping-add.JPG)
            <br><br>
        - Remove Items: <a name="remove"></a>
            1. The app allows the user to remove any item from the shopping list.
            ...
            1. If there are items on the list, it shows a warning that the user is opting to delete an item from the list and prompts the user to type in the name of the item to be removed.
            1. Once removed, the app then asks the user whether they would like to continue.
            1. The user can exit this mode by either pressing “n” when asked whether to continue or by pressing “0” when asked which item to remove.
            <br><br>
            ![Image of the remove items from shopping list menu](./assets/readme-images/shopping-remove.JPG)
            <br><br>
        - Clear List: <a name="clear"></a>
            1. The app lets the user clear the whole shopping list at once.
...
### Future Features <a name="future"></a>
  - Allow users to add new recipes and required ingredients.
...
## Testing and Bug Fixes <a name="testing"></a>
  - The application is thoroughly tested with various valid and invalid inputs and running the program in loops to find bugs and crashes.
  - Initially, some of the loops weren’t working as intended and would not break. This was solved through testing.
  - There were also minor input error issues which were resolved.

  - ## Validator Testing
    - The code has also been tested and verified via [PEP8 Online](http://pep8online.com/). No issues were found other than few wordy lines which were fixed.
  - ## Unfixed Bugs
...
The steps taken to deploy the project via Heroku are as follows:
  ...
  - Then follow these steps:
    ...
    1. In the settings tab for the new application create two Config vars. 
        ...
        - One is named PORT and has a value of 8000.
...
## Credits and Acknowledgement <a name="credits"></a>
  ...
  - ### Content:
    - The content of the app was written by the developer.
  - ### Acknowledgement:
